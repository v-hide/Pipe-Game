...
public class _3x32 implements ActionListener {
    JFrame frame;
    JButton b1;
    JButton b2;
    JButton b3;
    ...
    public _3x32 () {
        frame = new JFrame ("_3x32");
        wire = new ImageIcon(_3x32.class.getResource("pkg4qproj/resources/tiles/arrow.png"));
        wire2 = new ImageIcon(_3x32.class.getResource("pkg4qproj/resources/tiles/arrowR.png"));
        wire3 = new ImageIcon(_3x32.class.getResource("pkg4qproj/resources/tiles/arrowU.png"));
        wire4 = new ImageIcon(_3x32.class.getResource("pkg4qproj/resources/tiles/arrowL.png"));
        
        corner = new ImageIcon(_3x32.class.getResource("pkg4qproj/resources/tiles/corner.png"));
        corner2 = new ImageIcon(_3x32.class.getResource("pkg4qproj/resources/tiles/cornerR.png"));
        corner3 = new ImageIcon(_3x32.class.getResource("pkg4qproj/resources/tiles/cornerU.png"));
        corner4 = new ImageIcon(_3x32.class.getResource("pkg4qproj/resources/tiles/cornerL.png"));
        
        end = new ImageIcon(_3x32.class.getResource("pkg4qproj/resources/tiles/end.png"));
        end2 = new ImageIcon(_3x32.class.getResource("pkg4qproj/resources/tiles/endR.png"));
        end3 = new ImageIcon(_3x32.class.getResource("pkg4qproj/resources/tiles/endU.png"));
        end4 = new ImageIcon(_3x32.class.getResource("pkg4qproj/resources/tiles/endL.png"));
    ...
    public void actionPerformed (ActionEvent e) {
        ...
        ImageIcon icon = (ImageIcon)b9.getIcon();
            ...
            if (a1.equals(corner) && a2.equals(wire) && a3.equals(corner2) && a4.equals(bulb) && a6.equals(bulb3) && a7.equals(corner4) && a8.equals(end2) && a9.equals(corner3)) {
