...
public class _3x42 implements ActionListener {
    JFrame frame;
    JButton b1;
    JButton b2;
    JButton b3;
    ...
    public _3x42 () {
        frame = new JFrame ("_3x42");
        wire = new ImageIcon(_3x42.class.getResource("pkg4qproj/resources/tiles/arrow.png"));
        wire2 = new ImageIcon(_3x42.class.getResource("pkg4qproj/resources/tiles/arrowR.png"));
        wire3 = new ImageIcon(_3x42.class.getResource("pkg4qproj/resources/tiles/arrowU.png"));
        wire4 = new ImageIcon(_3x42.class.getResource("pkg4qproj/resources/tiles/arrowL.png"));
        
        corner = new ImageIcon(_3x42.class.getResource("pkg4qproj/resources/tiles/corner.png"));
        corner2 = new ImageIcon(_3x42.class.getResource("pkg4qproj/resources/tiles/cornerR.png"));
        corner3 = new ImageIcon(_3x42.class.getResource("pkg4qproj/resources/tiles/cornerU.png"));
        corner4 = new ImageIcon(_3x42.class.getResource("pkg4qproj/resources/tiles/cornerL.png"));
        
        end = new ImageIcon(_3x42.class.getResource("pkg4qproj/resources/tiles/end.png"));
        end2 = new ImageIcon(_3x42.class.getResource("pkg4qproj/resources/tiles/endR.png"));
        end3 = new ImageIcon(_3x42.class.getResource("pkg4qproj/resources/tiles/endU.png"));
        end4 = new ImageIcon(_3x42.class.getResource("pkg4qproj/resources/tiles/endL.png"));
        ...
        multi2 = new ImageIcon(_3x31.class.getResource("pkg4qproj/resources/tiles/3wayR.png"));
        multi3 = new ImageIcon(_3x31.class.getResource("pkg4qproj/resources/tiles/3wayU.png"));
        multi4 = new ImageIcon(_3x31.class.getResource("pkg4qproj/resources/tiles/3wayL.png"));
        
        Fmulti = new ImageIcon(_3x31.class.getResource("pkg4qproj/resources/tiles/F3way.png"));
        Fmulti2 = new ImageIcon(_3x31.class.getResource("pkg4qproj/resources/tiles/F3wayR.png"));
        Fmulti3 = new ImageIcon(_3x31.class.getResource("pkg4qproj/resources/tiles/F3wayU.png"));
        Fmulti4 = new ImageIcon(_3x31.class.getResource("pkg4qproj/resources/tiles/F3wayL.png"));
    ...
    public void actionPerformed (ActionEvent e) {
        ...
        ImageIcon icon2 = (ImageIcon)b2.getIcon();
            if (icon2.equals(Fmulti)) {
                b2.setIcon(Fmulti2);
            }
            else if (icon2.equals(Fmulti2)) {
                b2.setIcon(Fmulti3);
            }
            else if (icon2.equals(Fmulti3)) {
                b2.setIcon(Fmulti4);
            }
            else if (icon2.equals(Fmulti4)) {
                b2.setIcon(Fmulti);
            }
        }
        ...
        ImageIcon icon = (ImageIcon)b12.getIcon();
            ...
            if (a1.equals(corner) && a2.equals(Fmulti) && a3.equals(Fmulti) && a4.equals(corner2) && a5.equals(end3) && a6.equals(bulb3) && a7.equals(bulb3) && a8.equals(bulb3) && a9.equals(corner4) && a10.equals(multi3) && a11.equals(multi3) &&  a12.equals(corner3)) {
